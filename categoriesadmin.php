...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <a href="addcate.php" class="btn btn-outline-primary my-2">Add new Category</a>
          ...
          <tbody>
            <tr>
              <?php 
                ...
                <td><?php echo $row['catebrief']?></td>
                <td><a href="editcate.php?id=<?=$row['id']?>" class="btn btn-primary">edit</td>
                <td><a href="delcate.php?id=<?=$row['id']?>" class="btn btn-danger">delete</td>
                </tr>
              <?php
                }
              ?>
